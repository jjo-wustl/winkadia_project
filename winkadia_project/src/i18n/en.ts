...
const en = { // 영어 화면 문구를 모아둔 객체임
  ...
  footer: { // 푸터에서 쓰는 문구임
    ...
    terms: "Terms of Use", // /legal/terms 페이지 링크 라벨임
    privacy: "Privacy Policy", // /legal/privacy 페이지 링크 라벨임
    notice: "Legal Notice", // /legal/notice 페이지 링크 라벨임
    contactLabel: "Contact", // 문의 이메일 앞에 붙는 라벨임
  ...
  series: { // Series 페이지에서 쓰는 문구임
    ...
    films: { // 가로(16:9) 영상 섹션임
      title: "Films",
      desc: "Wide-screen videos",
    },
    shorts: { // 세로(9:16) 영상 섹션임
      title: "Shorts",
      desc: "Vertical short-form clips",
    },
    ipStatus: { // IP 섹션 상단에 노출하는 공개 상태 배지 문구임
      available: "Now Streaming",
      comingSoon: "Coming Soon",
    },
    comingSoonMessage: "Coming soon. Trailer and full series will arrive shortly", // Coming Soon IP placeholder 문구임
    states: { // 데이터 로딩/오류 상태 메시지임
      videoLoading: "Loading video...",
      videoError: "Could not load the video",
      thumbLoading: "Loading thumbnail...",
      thumbError: "Thumbnail unavailable",
