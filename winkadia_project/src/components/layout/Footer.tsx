...
//
// sanctuary 영역 하단 푸터 컴포넌트임.
// 게임홈(/sanctuary/game)에서는 푸터를 보여주고,
...
import { usePathname } from "next/navigation"; // 게임 플레이 경로에서는 푸터를 숨기기 위해 현재 경로를 가져옴
...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full overflow-hidden">
      {/* footer.png 위에 푸터 문구와 아이콘을 올리는 영역임 */}
      <img
        src="/footer.png"
        alt=""
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-4 pb-[2.4%] text-center">
        {/* footer.png 위 중앙에 푸터 내용을 배치함 */}
        <div className="relative px-5 py-3 sm:px-7 sm:py-4 lg:px-10 lg:py-5">
          {/* 글씨와 아이콘을 한 번 감싸는 기준 영역임 */}
          <div className="pointer-events-none absolute inset-[-76px] rounded-[999px] bg-[radial-gradient(ellipse_at_center,_rgba(255,255,255,1)_0%,_rgba(255,255,255,0.82)_38%,_rgba(255,255,255,0.42)_62%,_rgba(255,255,255,0)_88%)] blur-[6px]" />
          {/* 글씨와 아이콘 뒤에 흰색 그라데이션을 깔아 배경에 묻히지 않게 함 */}

          <div className="relative z-10">
            {/* 실제 푸터 콘텐츠를 그라데이션 위에 올림 */}
            <p
            ...
            <div className="mb-3 flex items-center justify-center gap-2.5 sm:mb-4 sm:gap-4 lg:mb-5">
              {/* SNS 아이콘 이미지 버튼들을 가로로 배치함 */}
            ...
            <div className="hidden items-center justify-center gap-4 text-[13px] font-black text-[#5f4b8f] sm:flex sm:text-[15px] lg:text-[18px]">
              {/* 푸터 약관, 개인정보, 법적 고지 링크 영역 */}
